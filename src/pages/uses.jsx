        ...
        <div className="space-y-20">
          ...
          <ToolsSection title="Music">
            ...
            <Tool title="Keyboard: Korg Nano Studio">
                My keyboard playing skills are so bad that I actually sold a full size electric keyboard and replaced it with this little thing. It&apos;s great for recording and playing in midi tracks, and it&apos;s so small it doesn&apos;t take up any space ( which is important in my house!)
            </Tool>
            ...
            <Tool title="Guitar: Jackson">
                I needed a guitar that I could use for recording, being primarily a bass player I find the Jackson guitar to be the most comfortable to play, with their slightly wider necks and low action. For the money it sounds great recorded.
            </Tool>
            </ToolsSection>
        </div>
      </SimpleLayout>
