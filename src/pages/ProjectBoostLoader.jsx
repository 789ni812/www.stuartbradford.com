...
const UnityGame = () => {
    ...
    return (
        <div className="w-[960px] h-[500px] mx-auto my-8">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-100 sm:text-5xl mb-2">
                Project Boost
            </h1>
            ...
            <div class="w-[960px] h-[500px] flex justify-center items-center">
                <div class="  mx-auto relative z-0">
                    <p class="text-3xl text-zinc-100">Loading...</p>
            ...
            <ul className="text-zinc-400 text-xs flex justify-center">
